  ...
  return (
    <div>
      <div id="backgroundImg">
        <img
          id="backgroundImgProper"
          src={typeof bar !== "undefined" ? bar.bar.bannerImg : null}
          alt=""
        />
      </div>
      <div id="columnsDiv">
        <div id="leftColumn">
          <div className="BorderBottom BorderTop">
            <h1 id="BarName">
              {typeof bar !== "undefined" ? bar.bar.name : null}
            </h1>
          </div>
          <span id="summary-span">
            <span id="summary-span-1">
              Average Review Score{" "}
              {typeof bar !== "undefined"
                ? bar.reviews_summary_data.overall
                : null}
            </span>
            <span id="summary-span-2">
              Number of Reviews{" "}
              {typeof bar !== "undefined"
                ? bar.reviews_summary_data.review_total
                : null}
            </span>
          </span>
          <div id="description-text">
            {typeof bar !== "undefined" ? bar.bar.description : null}
          </div>
          <div>
            <Photos props={typeof bar !== "undefined" ? bar.images : null} />
          </div>
          <div>
            <h3 className="BorderBottom" id="see-summary">
              See Summary of Ratings of{" "}
              {typeof bar !== "undefined"
                ? bar.reviews_summary_data.review_total
                : null}{" "}
              Bar-Goers{" "}
            ...
            <div>
              ...
              <span className="BorderRight">
                Food{" "}
                {typeof bar !== "undefined"
                  ? bar.reviews_summary_data.food
                  : null}
              </span>
              <span className="BorderRight">
                Service{" "}
                {typeof bar !== "undefined"
                  ? bar.reviews_summary_data.service
                  : null}
              </span>
              <span className="BorderRight">
                Ambience{" "}
                {typeof bar !== "undefined"
                  ? bar.reviews_summary_data.ambience
                  : null}
              </span>
              <span>
                Value{" "}
                {typeof bar !== "undefined"
                  ? bar.reviews_summary_data.value
                  : null}
              </span>
            </div>
          </div>
